...
namespace Series
{
    class Program
    {
        ...
        private static void AtualizarSerie()
        {
            ...
            int entraAno = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Digite a Descrição da Série: ");
            string entradaDescricao = Console.ReadLine();

            Serie atualizaSerie = new Serie(id: indiceSerie, genero: (Genero)entradaGenero, titulo: entradaTitulo, ano: entraAno, descricao: entradaDescricao);
